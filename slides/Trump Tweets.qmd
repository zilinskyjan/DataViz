---
title: "Citizens' evaluations of Trump tweets" 
author: "Tutorial by: J.Zilinsky (TUM)" 
institution: "Spring Semester 2025" 
#date: "" 
format: 
  revealjs: 
    theme: simple 
...
In this exercise, we will load a dataset of YouGov sentiment ratings of Trump tweets and explore how different people rate those tweets. 
...
## By the end of this slide deck, students should be comfortable:
...
## Creating a Tidy Data Frame {.smaller}
...
```
##
### Exploring Overall Sentiment Distribution {.smaller}
...
Feel free to modify the code and experiment with different subsets or additional variable transformations. Good luck!
