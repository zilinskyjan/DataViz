# Telling stories with R: Data Visualization {.unnumbered}
...
#### **Expectations**
	...
	- Please use your devices only to take notes
	- No multitasking
	- You are already fluent in R and R Studio
	- Get the most recent version of R; Install R Studio; install the tidyverse library
