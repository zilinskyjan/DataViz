...
::: {.callout-note}
## Note
These are lecture notes and tutorials which combine many of the materials that I have used for teaching at the Technical University of Munich between 2023 and 2026.
:::
...
## Lesson 1: The first chart you produce is your "draft zero".

Iterate and create reasonably clear and self-contained visual exhibits.

## Lesson 2: Think of output from statistical models as data. Summarize it visually.
...
After taking this course, students will be expected to be able to present real data clearly and to identify strengths and weaknesses of existing data displays and dashboards.

We will be graphing various types of evidence including:

- Macroeconomic indicators (inflation, spending, debt, deficits)
- Public opinion surveys (toplines, cross-tabs, weighted estimates)
- Summaries of statistical models (coefficients, predictions, uncertainty)
- Quantitative representations of text (news headlines, social media metadata)
- Health and demographic indicators (e.g., life expectancy)
- Financial time series (stock prices and returns)

If you want to browse datasets up front, see `datasets.qmd` for links and short descriptions.
...
- Optional: machine learning output (regression trees, most important variables, etc.)