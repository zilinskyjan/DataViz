...
# If you lack of any of the above,
# you need to run: 
...
d1 <- read_dta("https://raw.githubusercontent.com/zilinskyjan/DataViz/temp/data_AJPS2021/Study1.dta")
...
d2 <- read_dta("https://raw.githubusercontent.com/zilinskyjan/DataViz/temp/data_AJPS2021/Study2.dta")

# And a dataset with many populism items:
d3 <-read_dta("https://raw.githubusercontent.com/zilinskyjan/DataViz/temp/data_AJPS2021/Replication.dta")
