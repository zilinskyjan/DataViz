...
1.  Calculate some aggregate statistics first. Think of this "new" data object as just a new spreadsheet.
...
Naturally, we'll want to filter out missing observations (respondents who were not asked the favorability question):
...
### Plotting some descriptive statistics
